    ...
    <div className="min-h-screen bg-[#0a0a1a] text-white">
      ...
      <nav className="sticky top-0 z-50 backdrop-blur bg-[#0a0a1a]/80 border-b border-gray-800">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="#how-we-work" className="text-sm text-gray-400 hover:text-white transition">
              How We Work
            </a>
            <a
              href="#contact"
              className="text-sm bg-[#00d4ff] text-[#0a0a1a] px-4 py-2 rounded-lg font-semibold hover:bg-[#00bfe0] transition"
            >
              Get in Touch
            </a>
          </div>
          <button
            ...
            className="md:hidden flex items-center gap-2 border border-gray-700 rounded-lg px-3 py-2 text-sm text-gray-400 hover:text-white transition"
          >
        ...
        {menuOpen && (
          <div className="md:hidden border-t border-gray-800 px-6 py-4 flex flex-col gap-4">
            ...
            <a href="#how-we-work" onClick={() => setMenuOpen(false)} className="text-sm text-gray-400 hover:text-white transition">
              How We Work
            </a>
            <a
              href="#contact"
              onClick={() => setMenuOpen(false)}
              className="text-sm bg-[#00d4ff] text-[#0a0a1a] px-4 py-2 rounded-lg font-semibold hover:bg-[#00bfe0] transition text-center"
            >
              Get in Touch
            </a>
          </div>
      ...
      <section id="start" className="max-w-6xl mx-auto px-6 py-16 md:py-32 flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 text-lg text-gray-400 max-w-2xl">
            We build modern, scalable solutions using open source technologies.
            From custom web apps to self-hosted infrastructure — we help
            businesses take full control of their digital stack.
          </p>
          <a
            href="#contact"
            className="inline-block mt-8 bg-[#00d4ff] text-[#0a0a1a] px-6 py-3 rounded-lg font-semibold hover:bg-[#00bfe0] transition"
          >
            Get in Touch
          </a>
        </div>
        <div className="select-none" aria-hidden="true">
          <div
            className="w-48 h-48 md:w-56 md:h-56 rounded-full border-2 border-[#FFD700] flex items-center justify-center"
            style={{ animation: "glitch 3s infinite" }}
          >
            <span className="text-[#FFD700] font-mono text-5xl md:text-6xl font-bold">./vs</span>
          </div>
          <style>{`
            @keyframes glitch {
              0%, 85%, 100% { opacity: 1; transform: translate(0, 0); }
              86% { opacity: 0.7; transform: translate(-2px, 1px); }
              87% { opacity: 0.4; transform: translate(2px, -1px); }
              88% { opacity: 0.8; transform: translate(-1px, 2px); }
              89% { opacity: 1; transform: translate(1px, -1px); }
              90% { opacity: 0.3; transform: translate(0, 0); }
              91% { opacity: 1; transform: translate(-2px, -1px); }
              92% { opacity: 0.6; transform: translate(1px, 1px); }
      ...
      <section id="what-we-build" className="max-w-6xl mx-auto px-6 py-20">
        ...
        <p className="mt-4 text-gray-400 text-center max-w-2xl mx-auto">
          From web applications and APIs to self-hosted infrastructure — here is
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {solutions.map((s) => (
            <div
              key={s.title}
              className="bg-[#111128] border border-gray-800 rounded-lg p-6 hover:border-[#00d4ff]/40 transition"
            >
      ...
      <section id="how-we-work" className="max-w-6xl mx-auto px-6 py-20">
        ...
        <p className="mt-4 text-gray-400 text-center max-w-2xl mx-auto">
          A straightforward process built around your project and your pace.
        </p>
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          {steps.map((s) => (
            <div
              key={s.num}
              className="bg-[#111128] border border-gray-800 rounded-lg p-6"
            >
              <span className="text-[#00d4ff] text-sm font-mono font-bold">
                {s.num}
              </span>
      ...
      <section id="contact" className="max-w-6xl mx-auto px-6 py-20">
        ...
        <p className="mt-4 text-gray-400 text-center max-w-2xl mx-auto">
          Send us a message and we will review your project. Depending on scope
          and complexity, we may schedule a call to discuss details before
          providing an estimate.
        </p>
        <div className="mt-8 text-center">
          <a
            href="mailto:hello@viewsmash.com"
            className="text-[#00d4ff] hover:text-[#00bfe0] text-lg font-semibold transition"
          >
            hello@viewsmash.com
          </a>
        </div>
      ...
      <footer className="border-t border-gray-800">
        <div className="max-w-6xl mx-auto px-6 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="#how-we-work" className="text-sm text-gray-500 hover:text-white transition">
              How We Work
            </a>
            <a href="#contact" className="text-sm text-gray-500 hover:text-white transition">
              Get in Touch
            </a>
          </div>
        </div>
      ...
      {showTop && (
        <button
          ...
          className="fixed bottom-6 right-6 bg-[#00d4ff] text-[#0a0a1a] w-10 h-10 rounded-full flex items-center justify-center hover:bg-[#00bfe0] transition"
